...
export const DETAIL_FIELD_CATALOG: DetailFieldDef[] = [
  ...
  { key: 'entry_timeframes', label: 'Entry Timeframes', kind: 'multi-select', propertyName: 'entry_timeframe', field: 'entry_timeframes', defaultVisible: true },
...
export const DEFAULT_COLUMNS: ColumnDefinition[] = [
  ...
  { key: 'alignment', label: 'HTF Timeframes', type: 'multi-select', sortable: false, filterable: true, hideable: true, width: 'minmax(90px, 1.2fr)', propertyName: 'timeframe', category: 'editable' },
  { key: 'entry_timeframes', label: 'Entry Timeframes', type: 'multi-select', sortable: false, filterable: true, hideable: true, width: 'minmax(90px, 1.2fr)', propertyName: 'entry_timeframe', category: 'editable' },
...
export const DEFAULT_PROPERTY_OPTIONS: Omit<PropertyOption, 'id' | 'user_id' | 'created_at' | 'updated_at'>[] = [
  ...
  // Sessions are managed in Settings → Sessions (session_definitions table). Do not seed here.
  // Timeframes
