      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex flex-1 min-h-0">
                  ...
                  const renderSection = () => {
                    switch (sectionKey) {
                      ...
                      case 'comments':
                        return (
                          <div>
                            <Label className="text-sm font-semibold mb-3 block">Comments & Notes</Label>
            ...
            {showProperties && (
              <div className="w-80 border-l border-border bg-muted/20 flex-shrink-0 overflow-auto">
                <div className="p-4">
