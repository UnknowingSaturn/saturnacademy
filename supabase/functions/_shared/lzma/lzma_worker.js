...
// Source: https://unpkg.com/lzma@2.3.2/src/lzma_worker.js (MIT, Nathan Rugg)
// Only change from upstream: the trailing `this.LZMA = ...` global assignment
// is replaced with an ESM `export { LZMA }` so Deno can import it directly.
// Used to inflate Dukascopy .bi5 payloads (LZMA-alone container) in ingest-bars.
