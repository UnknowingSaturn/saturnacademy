...
// Vendored copy of shared/quant/symbolAliasing.ts for the Deno edge bundler.
...
const FAMILY_MAP: Record<string, string[]> = {
  ...
  BTCUSD:  ["BTCUSD", "BITCOIN", "BTC", "BTCUSDT", "XBTUSD", "XBTUSDT", "XBT"],
  ETHUSD:  ["ETHUSD", "ETHEREUM", "ETH", "ETHUSDT", "ETHPERP"],
