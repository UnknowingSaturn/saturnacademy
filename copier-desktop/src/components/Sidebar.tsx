...
export type NavItem = "dashboard" | "positions" | "receivers" | "activity" | "terminals" | "diagnostics" | "settings";
...
export default function Sidebar({ activeItem, onNavigate, onShowWizard, status, masterHeartbeat }: SidebarProps) {
